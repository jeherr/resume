...
Computational chemist \& machine‑learning scientist with experience building deep‑learning models for molecular properties and force‑field development. Developed datasets with over 10 M conformations, authored 12 peer‑reviewed papers (1,700+ citations), and cut CPU cost of QM pipelines by up to 40\%. Proficient in Python, PyTorch, TensorFlow, RDKit, and HPC workflows.
...
\textbf{Postdoctoraate (computational chemistry and machine learning), Dr.\ John Chodera} \hfill \emph{Sept 2021 -- Jun 2022}
\vspace{-0.4em}
\begin{itemize}\itemsep -0.4em
  \item co-built \emph{SPICE} dataset (700 k mols, 17 m confs); trained transformer ff with < 1 kcal/mol off-equilibrium MAE
\end{itemize}

\textbf{Graduate Student/Postdoctorate (computational chemistry and machine learning), Dr.\ Olaf Wiest} \hfill \emph{Aug 2018 -- Oct 2020}
\vspace{-0.4em}
\begin{itemize}\itemsep -0.4em
...
\textbf{Graduate Student (computational chemistry and machine learning), Dr.\ John Parkhill} \hfill \emph{Aug 2015 -- Aug 2018}
\vspace{-0.4em}
\begin{itemize}\itemsep -0.4em
